...
//            1, numPostRequestsEachThreadPhase1, mainLatch, sharedStat);
    ...
    int throughput = (int) (sharedStat.getSucessfullPosts()/wallTime);
    double avgRespTime = getAvgResponseTimes(sharedStat.getResponseTimes());
    ...
    System.out.println("throughput (lambda): " + throughput );
    System.out.println("response times (resp): " + avgRespTime );

  }

  private static double getAvgResponseTimes(List<Long> responseTimes) {
    double sum = 0;
